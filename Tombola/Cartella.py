...
class Cartella:
    ...
    def posizione_libera_colonna(self,i):
        ...
        '''
        Metodo genera_cartella: il metodo genera_cartella si occupa di inserire in 5 posizioni randomiche per ogni riga il numero 1 per contrassegnare che quella casella conterrà un numero
