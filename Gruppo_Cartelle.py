...
class Gruppo_Cartelle:
    ...
    #         somma_el_col = singolacartella.conta_elementi_colonne(0)
    ...
    # '''il metodo verifica che ciascuna colonna: dalla 2 alla 8 dell' intero gruppo siano formate da 10 elementi'''
    ...
    #             somma_el_col = i.conta_elementi_colonne(j)
...
######################################################
    ...
    def genera_gruppo(self):
          ...
          # while condiz == False:
          #     self.crea_lista()
          #     # if self.verifica_prima_colonna():
          #     #     if self.verifica_ultima_colonna():
